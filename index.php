        ...
        <div class="row align-items-center min-vh-hero gy-5">
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-3 reveal-item delay-3">
                    <a class="btn btn-sun btn-lg" href="<?= e(url('auth/register.php')) ?>">Create student account <span aria-hidden="true">→</span></a>
    ...
    <div class="container">
        <div class="row align-items-end mb-5 gy-3">
            <div class="col-lg-7">
                ...
                <h2 class="section-title">Everything a course needs.<br>Nothing it doesn’t.</h2>
            </div>
            <div class="col-lg-5">
